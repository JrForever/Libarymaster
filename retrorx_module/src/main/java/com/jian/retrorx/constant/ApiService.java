package com.jian.retrorx.constant;
...
public interface ApiService {
     ...
     * http://qt.qq.com/php_cgi/news/php/varcache_getnews.php?id=12&page=0&plat=android&version=9724
     */
    @GET("news/{zanwei}/varcache_getnews.php")
    Call<BaseEntity<List<NewsInfo>>> getNewsInfoPath(@Path("zanwei") String zanwei,
                                                     @Query("id") int id,
                                                     @Query("page") int page,
                                                     @Query("plat") String plat,
    ...
    Call<GameInfo<GameItem>> getGameInfo(@Field("platform") String platform,
    ...
    @FormUrlEncoded
    @POST("app/game/game_list/")
    Call<GameInfo<GameItem>> getGameInfo(@FieldMap Map<String, String> map);

    /**
     * 7.Body注解：
     * 另外可用来上传json格式的数据，图片等
     */
    @POST()
    ...
    Call<ResponseBody> getBolg(@Path("id") int id);
    ...
    @Multipart
    @POST("upload/upload")
    Call<ResponseBody> upload1(@Part("file" + "\";filename=\"" + "test.png") RequestBody file);

    @Multipart
    @POST("xxxxx")
    Call<ResponseBody> upload2(@Part MultipartBody.Part file);
    ...
    @Multipart
    @POST("upload/upload")
    Call<ResponseBody> upload3(@PartMap Map<String, RequestBody> map);

    @Multipart
    @POST("upload/upload")
    Call<ResponseBody> upload4(@PartMap Map<String, MultipartBody.Part> map);
    ...
    @Multipart
    @POST("upload/upload")
    Call<ResponseBody> upload5(@FieldMap() Map<String, String> params,
